...
void draw() {
  ...
  // Draw the sun behind the mountains in 3D
  pushMatrix();
  translate(400, 400, 400); // Position the sun behind the mountains
  fill(random(200,200), random(200,200),random (200,255)); // Yellow color for the sun
  noStroke();
  sphere(100); // Draw the sun as a sphere with radius 100
  popMatrix();
